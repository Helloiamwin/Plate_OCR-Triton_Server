...
class TritonPythonModel:
    def initialize(self, args):
        ...
        output_config_0 = pb_utils.get_output_config_by_name(self.model_config, "pre_text_det_outout_images")
        self.output_dtype_0 = pb_utils.triton_string_to_numpy(output_config_0["data_type"])

        output_config_1 = pb_utils.get_output_config_by_name(self.model_config, "pre_text_det_outout_shape_list")
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            out_tensor_0 = pb_utils.Tensor("pre_text_det_outout_images", results)
            out_tensor_1 = pb_utils.Tensor("pre_text_det_outout_shape_list", result_shape_list)
